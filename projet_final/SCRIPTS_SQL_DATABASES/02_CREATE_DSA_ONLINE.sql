/*******************************************************************************
   Création des tables DSA_ONLINE
   Structure identique à Chinook + colonnes de traçabilité (*_Date) + CHANNEL_ID pour Invoice
********************************************************************************/

USE [DSA_ONLINE_LOKOUN_THYS];
GO
...
(
    ...
    CONSTRAINT [CK_Invoice_Channel_Online] CHECK ([CHANNEL_ID] = 1)  -- Vérification que CHANNEL_ID = 1 pour DSA_ONLINE
);
GO
...
PRINT 'Tables DSA_ONLINE créées avec succès';
PRINT 'NOTE: Toutes les factures dans DSA_ONLINE ont CHANNEL_ID = 1 (Source: Chinook - En ligne)';
GO
